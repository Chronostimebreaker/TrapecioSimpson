...
public class Simpson1_3 extends Base {
    ...
    public void consola() {
        ...
        double a = consola.getNumero("Ingresa el Valor para x0(a)");
        double xm = consola.getNumero("Ingresa el Valor para x1");
        double b = consola.getNumero("Ingresa el Valor para x2(b)");
